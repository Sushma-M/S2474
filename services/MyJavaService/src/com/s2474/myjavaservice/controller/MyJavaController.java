...
package com.s2474.myjavaservice.controller;

import com.s2474.myjavaservice.MyJavaService;
...
public class MyJavaController {
    ...
    @RequestMapping(value = "/testJavaSer", produces = "application/json", method = RequestMethod.GET)
    public String testJavaSer(@RequestParam(value = "str1", required = false) String str1, @RequestParam(value = "str2", required = false) String str2) {
        return myJavaService.testJavaSer(str1, str2);
    }
}
