...
import com.s2474.classicmodels.service.ClassicmodelsQueryExecutorService;
...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/getCustomer", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeGetCustomer(@RequestParam(value = "num", required = false) java.lang.Integer num, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query getCustomer");
        Page<Object> result = queryService.executeGetCustomer(pageable, num);
